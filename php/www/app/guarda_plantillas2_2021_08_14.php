...
if($ban==0)
{	
						$query2="INSERT INTO plantillas2(sucursales_id,nombre)  VALUES('".$ubicacion_id."','".$nombre."')";

						$resultado = mysql_query($query2);
						
						$query2="select id from plantillas2 where sucursales_id='".$ubicacion_id."' and nombre='".$nombre."' " ;
				$res=mysql_query($query2,$con);
						...
						for ($x = 0; $x < count($equipos)-1; $x++)
		 				{					
		 					$query2="INSERT INTO deta_plantilla2(equipos_id,plantillas_id,cantidad,frecuencia,p_unitario,p_total)  VALUES('".$mat[$x]."','".$plantilla_id."','".$cantidad[$x]."','0','0','0')";
