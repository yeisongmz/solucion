...
function buscar(){
	...
	if (  fecha_remision==''  ){
		...
		document.getElementById('buscador').src='busca_plantillas2.php?nombre='+strUser+'&fe_remision='+fecha_remision	;
	}
}
// ---------------------------------------------------------------------
...
<body>
	...
	<!-- MARCO DE DATO PARA ULTIMO ENVIO -->
	<div id="marco" class="cuadrado-2" style="position:absolute ;margin-left:560px;margin-top:210px;z-index:30" ></div>
	
<!-- FORMULARIO -->
<form id="form1" name="form1" method="post" action="guarda_remision_simple.php">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    ...
    <tr align="center" class="fondo_encabezado">
      ...
      <tr class="eiquetas">
		...
		<!--LISTA DE PLANTILLAS -->
		<!--================================================================== -->		
        <td> <select name="select" id="select" onChange="buscar();" style=" width:290px;background-color:#C1AC7F">
		 ...
		 <!--================================================================== -->		
		  <!--DATO DE ULTIMO ENVIO DE LA PLANTILLA ================== -->	
		  <!--ESTA FECHA SE CARGA EN BUSCA_PLANTILLAS2.PHP = -->				  
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;F.ult.envio:</td>
        <td><input  id="dato1" type="text" name="dato1" readOnly style="border:0;width:150px; font-size:18px"  ></td>
      ...
      <tr class="eiquetas">
        <td height="46">&nbsp;</td>
        <td><span style="font-weight:bold">* Linea roja indica que el insumo no corresponde enviar todavia, teniendo en cuenta fecha de ult.envio y frecuencia</span><input type="text" name="textfield21" id="textfield21" onKeyUp="format(this);bajar2(this,event);" autocomplete="off" style="visibility:hidden"></td>
        <td>&nbsp;</td>
