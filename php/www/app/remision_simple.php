...
function Creadora2(precio,producto,cantidad,unidad) {
	...
	//table.onmouseover(highlightBG2(this));
	//row.onmouseover=highlightBG(this);
	//row.addEventListener('onmouseover', function() { highlightBG(this);}, true);
	//checkbox.addEventListener('click', function() { leer2(this,this.id);}, true);
	//onMouseOver="highlightBG(this);" onMouseOut="highlightBG2(this);" 
...
// CREO UN ELEMENTO DEL TIPO INPUT CON document.createElement("NOMBRE TAG HTML QUE QUIERO CREAR");
 ...
 //cell0.addEventListener('onMouseOver', function() { highlightBG(this);}, true);
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    ...
    <tr align="center" class="fondo_encabezado">
      ...
      <tr class="eiquetas">
        ...
        <td width="33%">
        <input type="text" name="textfield3" id="textfield3" onKeyUp="return teclaGRAL(this, event,'skills2');" value="<?php echo date('d/m/Y');?>" autocomplete="off"></td>
