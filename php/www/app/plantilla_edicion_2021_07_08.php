  ...
  <table width="100%" height="237" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    ...
    <tr class="fondo_encabezado">
      ...
      <tr>
        ...
        <td align="left"><input name="button2" type="button" class="boton3" id="button2" value="Guardar" onClick="preparacion2() " style="width:85px"></td>
        </tr>
    </tbody>
  </table>
  ...
  while($query4=mysql_fetch_array($query2))
      ...
      <tr  id="3000" class="eiquetas"  >
          ...
          <td width="30%" height="26">
			  <input name="textfield19" type="text" id="<?php echo $id2;?>" readonly style="width:30%; border:none; height:100%" value="<?php echo $query4['descrip']; ?>">
		  </td>
