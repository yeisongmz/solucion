...
if($ban==0)
{	
						$query2="INSERT INTO plantillas(sucursales_id,nombre,es_con_frecuencia,horas_presupuestadas)  VALUES('".$ubicacion_id."','".$nombre."','NO','".$_POST['horas']."')";
				...
				$res=mysql_query($query2,$con);
						...
						for ($x = 0; $x < count($equipos)-1; $x++)
		 				{					
		 					$query2="INSERT INTO deta_plantilla(equipos_id,plantillas_id,cantidad,frecuencia,p_unitario,p_total,es_con_frecuencia)  VALUES('".$mat[$x]."','".$plantilla_id."','".$cantidad[$x]."','0','0','0','NO')";
