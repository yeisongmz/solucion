...
$query2=mysql_query("SELECT deta_plantilla.*,equipos.`descrip` FROM deta_plantilla,equipos WHERE deta_plantilla.plantillas_id='".$id_plantilla."' AND deta_plantilla.`equipos_id`=equipos.`id`   ");											
						?>
  ...
  <table width="100%" height="237" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    ...
    <tr class="fondo_encabezado">
      ...
      <tr>
        ...
        <td width="58%">
        <input name="textfield" type="text" autofocus id="textfield" autocomplete="off" onKeyUp="return teclaGRAL(this, event,'skills4')" size="60" maxlength="100" value="<?php echo $nombre;?>"></td>
        <td width="18%">
          <input type="text" name="textfield1900" id="textfield1900" value="<?php $aux=explode('--',$id_plantilla);$id_plantilla=$aux[0]; echo $id_plantilla;?>" style="visibility:hidden"></td>
        </tr>
      <tr>
...
<table width="100%" border="1" class="tabla1" cellspacing="0" cellpadding="0" id="mitabla" style=" border-collapse: separate">
  ...
  while($query4=mysql_fetch_array($query2))
      ...
      <tr  id="3000" class="eiquetas"  >
          <td width="25%"  height="26"><input type="text" name="textfield7" id="<?php echo $id1;?>" style="width:98%; height:100%; border-color:#BEA6F1" value="<?php echo $query4['cantidad']; ?>" autocomplete="off"></td>    
          <td width="40%" height="26"><input name="textfield19" type="text" id="<?php echo $id2;?>" readonly style="width:98%; border:none; height:100%" value="<?php echo $query4['descrip']; ?>"></td>
          <td width="24%" align="right" height="26"><input type="text" name="textfield21" id="<?php echo $id3;?>" style="width:98%; text-align:right; height:100%; border-color:#BEA6F1" value="<?php echo $query4['frecuencia']; ?>" autocomplete="off"></td>
          <td width="11%" align="center" height="26"><input type="checkbox" name="checkbox" id="<?php echo $id4;?>" style="width:98%; height:18px"  onClick="leer2(this,this.id);">
          </td>
    </tr>
    <?php 
	  $id1=$id1+1;
