...
if (isset($_GET['id']))
{
		...
		$sql="select id,nom_archivo,referencia,path_archivo from adjuntos where relacion ='EMPRESA' and referencia='".$cliente_id."'  order by nom_archivo limit 200";	
}
else
{
	$sql="select id,nom_archivo,referencia,path_archivo from adjuntos where relacion ='EMPRESA'  order by nom_archivo ";	
}
