...
for($fila3=0;$fila3<$fila2;$fila3++){
	...
	$query2="select jornalxhora,jornalxmin,sueldoreal from personal where id='".$mat_cabecera[$fila3][5]."' and estado = 1 " ;
	$res=mysql_query($query2,$con);
	$jornalxhora=0;
	while($query4 = mysql_fetch_array($res) )
		{
        ...
        //echo 'jornal ' . $jornalxhora . ' cant horas ' .  $mat_cabecera[$fila3][4]; die() ;
			$sueldoreal = $jornalxhora * $mat_cabecera[$fila3][4];
...
// $query2="select *  from asistencia where personal_id='".$mat_cabecera[$fila3][5]."' and fecha_asistencia>='".$desde."' and fecha_asistencia<='".$hasta."' and liquiregular_id='".$id[0]."' " ;
    ...
    $id_personal = $mat_cabecera[$fila3][5] ;
	...
	$aux=$aux*$jornalxhora;   // gsxhora
	$aux2=$domingo_nocturno*1.3;
	$aux2=$aux2*$jornalxhora;  // gsxhora
    ...
    //
    // if($id_personal==91){
    //     echo '$domingo_diurno:' . $domingo_diurno . '<br>' ;
    //     echo '$aux:' . $domingo_diurno*1.3 . '<br>' ;
    //     echo '$domingo_nocturno:' . $domingo_nocturno . '<br>' ;
    //     echo '$aux2:' . $domingo_nocturno*1.3 . '<br>' ;
    //     echo '$aux2:'.($domingo_nocturno*1.3)*$jornalxhora .'<br> ' ;
    //     echo 'TOTAL = ' .$total_cobro_diario ; die() ;
    //
    // }
		/*
...
// ******************************************************************************************
	...
	while($query4 = mysql_fetch_array($res) )
		...
		while($query4 = mysql_fetch_array($res) )
            ...
            $query2="select * from liquidetalle where liquiregular_id='".$id[0].
            "'  and tipo='DESCUENTO' and concepto like'Ausencia injust.%'  " ;
	        $res=mysql_query($query2,$con);
...
//***************************   INGRESOS - BONIFICACION ***********************************
                        ...
                        //$total_bobif = $total_bobif + $sueldoreal ;
