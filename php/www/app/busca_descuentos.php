  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    <tbody>
      <tr class="fondo_encabezado">
        <td height="41" colspan="4" align="center">Descuentos</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="27%" align="right"><input name="button" type="button" class="boton3" id="button" value="Todos">&nbsp;<input name="button" type="button" class="boton3" id="button" value="Imp">&nbsp;</td>
      </tr>
      <tr>
        <td width="39%">&nbsp;</td>
        <td width="18%">&nbsp;</td>
