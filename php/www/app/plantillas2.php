...
<body>
<form id="form1" name="form1" method="post" action="guarda_plantillas2.php">

  <table width="70%" height="237" border="0" cellpadding="0" cellspacing="0" class="tabla1" align="center">
    <tbody>
    <tr  bgcolor="#65A9E8">
      <td height="36" colspan="3" align="center">Plantillas (sin frecuencia)</td>
      </tr>
      <tr>
        <td width="17%" height="36">Nombre de la plantilla*</td>
        <td width="69%">
        <input name="textfield" type="text" autofocus id="textfield" autocomplete="off" onKeyUp="return teclaGRAL(this, event,'skills4')" size="70" maxlength="100"></td>
        <td width="14%">&nbsp;</td>
        </tr>
      <tr>
        <td height="43">Sucursal/Cliente*</td>
        <td>
  			<input autofocus id="skills4" placeholder="Ingrese Destino" size="53" style="font-size:18px" name="skills4" onKeyUp="return teclaGRAL(this, event,'skills2')">
      ...
      <tr>
        <td  bgcolor="#B3D48D">Producto/equipo*</td>
        <td bgcolor="#B3D48D">
  			<input autofocus id="skills2" placeholder="Ingrese Equipo" size="53" name="skills2" style=" font-size:18px"  onKeyUp="return teclaGRAL(this, event,'textfield3')" >
      	    
        </td>
        <td bgcolor="#B3D48D">&nbsp;</td>
        </tr>
      <tr>
        <td height="29" bgcolor="#B3D48D">Cantidad*</td>
        <td bgcolor="#B3D48D">
          <input name="textfield3" type="text" id="textfield3" autocomplete="off" onKeyUp="bajar2(this,event);" size="24" ></td>
        <td bgcolor="#B3D48D">&nbsp;</td>
        </tr>
      <tr>
        <td height="34" bgcolor="#B3D48D"><label for="horas">Horas Presupuestadas:</label></td>
        <td bgcolor="#B3D48D">
        <input name="horas" type="text" id="horas" value="0" size="10">          
        ...
        <td align="center" bgcolor="#B3D48D"><input name="button2" type="button" class="boton3" id="button2" value="Guardar" onClick="preparacion2() " style="width:80px"></td>
        </tr>
    </tbody>
  </table>
  <table width="70%" border="0" class="tabla1" cellspacing="0" cellpadding="0" id="tabla" align="center">
  <tbody>
...
<table width="70%" border="1" class="tabla1" cellspacing="0" cellpadding="0" id="mitabla" style=" border-collapse: separate" align="center">
  <tbody>
