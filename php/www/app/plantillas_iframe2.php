...
if ($q<>'')
{
	 $q=$_GET['q'];
	//echo $q."   hola hola"."<br>";
 	$sql="SELECT * FROM plantillas WHERE nombre LIKE '".$q."%' and es_con_frecuencia='NO'  order by nombre";
}
else
{
	
	$sql="SELECT * FROM plantillas where es_con_frecuencia='NO' order by nombre";	
}
//echo $sql;
...
// 	font-family:"Gill Sans", "Gill Sans MT", "Myriad Pro", "DejaVu Sans Condensed", Helvetica, Arial, sans-serif;
	...
	//echo '<td >'."<a href='#' style='font-size:12px;font-weight:normal;text-decoration:none;color:#0B0B0B;font:Arial;font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif;'  >".$fila['numero']." </a> ".'</td>';
