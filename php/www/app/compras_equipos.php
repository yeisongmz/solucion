...
<form id="form1" name="form1" method="post" action="guarda_compra_equipos.php">
<div class="polaroid7">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    <tbody>
      <tr>
        <td height="45" colspan="5" align="center" class="fondo_encabezado"><span class="titulo2">Compra de Equipos e Insumos</span></td>
      </tr>
       <tr  bgcolor="#A8A4A4">
        <td width="18%" height="30" class="eiquetas">&nbsp;Proveedor*</td>
        <td width="26%"><div class="ui-widget">
  			<input autofocus id="skills4" placeholder="Ingrese Proveedor" size="30" name="skills4"  onKeyUp="return teclaGRAL(this, event,'skills3')"   >
      	</div></td>
        <td width="23%" align="right"><span class="eiquetas">Destino*&nbsp;</span></td>
        <td colspan="2" align="right"><span class="ui-widget">
          <input autofocus id="skills3" placeholder="Ingrese Destino" size="28" style="width:200px; font-size:18px" name="skills3" onKeyUp="return teclaGRAL(this, event,'number2')"></span>&nbsp;</td>
        
       </tr>
       <tr  bgcolor="#A8A4A4">
         <td height="28" valign="top" class="eiquetas">&nbsp;Fecha*</td>
         <td valign="top"><span class="ui-widget">
           <input name="textfield" type="text" id="textfield"  onChange="document.getElementById('number2').focus();" size="10" readonly value="<?php echo date('d-m-Y');?>" >
         ...
         <td colspan="2" rowspan="2" align="right"><textarea name="textarea" cols="36" rows="3" maxlength="250" id="textarea" style="width:200px; font-size:18px"></textarea>&nbsp;</td>
       </tr>
       <tr  bgcolor="#A8A4A4">
         <td height="20" valign="top" class="eiquetas">&nbsp;Nº Factura*</td>
         <td valign="top"><span class="ui-widget">
           <input type="text"  name="number2" id="number2" onKeyUp="return teclaGRAL(this, event,'textfield18');format(this)" autocomplete="off">
         </span></td>
       </tr>
       <tr bgcolor="#A8A4A4">
         ...
         <td colspan="2" align="right"><span class="ui-widget">&nbsp;&nbsp;<input name="textfield7" type="text" id="textfield7" onFocus="format(this);" onBlur="format(this);" onChange="format(this);" value="0" size="18" style="text-align:right"    readonly></span>&nbsp;</td>
       </tr>
...
<input type="text" name="number3" id="number3" size="10" onChange="format(this);" onKeyUp="format(this);bajar(this,event);" autocomplete="off">
  ...
  <tbody>
      <tr  id="3000" class="eiquetas"  >
          ...
          <td width="15%" align="right" height="1px">&nbsp;</td>
		  <td width="12%" align="right" height="1px">&nbsp;</td>          
  ...
  <iframe id="deta" height="100" width="200"  style="visibility:hidden"></iframe>
 ...
 <input name="textfield9" type="text" id="textfield9" value="699"  readonly style="visibility:hidden">
  ...
  <input name="textfield15" type="text" id="textfield15" style="visibility:hidden" value="0" readonly>
</form>
