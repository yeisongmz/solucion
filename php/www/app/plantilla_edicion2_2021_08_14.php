...
$query2=mysql_query("SELECT * from plantillas2 where id='".$id_plantilla."'   ");
...
$query2=mysql_query("SELECT deta_plantilla2.*,equipos.`descrip` FROM deta_plantilla2,equipos WHERE deta_plantilla2.plantillas_id='".$id_plantilla."' AND deta_plantilla2.`equipos_id`=equipos.`id` ORDER by equipos.`descrip` asc");
						?>
...
<div class="polaroid100">
  <table width="50%" height="237" border="0" cellpadding="0" cellspacing="0" class="tabla1" align="center">
    ...
    <tr bgcolor="#649CDD" >
      ...
      <tr>
        <td height="34" bgcolor="#A4A2A2">&nbsp;</td>
        <td bgcolor="#A4A2A2"><input name="textfield2" type="text" id="textfield2" autocomplete="off"onKeyUp="bajar2(this,event);" size="24" maxlength="10" style="visibility:hidden;"></td>
