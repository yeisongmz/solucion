  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla1">
    <tbody>
      <tr class="fondo_encabezado">
        <td height="41" colspan="4" align="center">Ausencias</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="28%" align="right"><input name="button" type="button" class="boton3" id="button" value="Todos">&nbsp;<input name="button" type="button" class="boton3" id="button" value="Imp">&nbsp;</td>
      </tr>
      <tr>
        <td width="41%">&nbsp;</td>
        <td width="15%">&nbsp;</td>
      ...
      <tr class="fondo_encabezado_buscador">
        ...
        <td>Fecha</td>
        <td colspan="2" align="right">Motivos&nbsp;</td>
      </tr>
      <tr class="eiquetas">
        <td>Personal 1</td>
        <td>12-05-2016</td>
        <td colspan="2" align="right">Motivo 1&nbsp;</td>
      </tr>
      <tr class="eiquetas">
        <td>Personal 2</td>
        <td>15-05-2016</td>
        <td colspan="2" align="right">Motivo 2&nbsp;</td>
      </tr>
      <tr class="eiquetas">
        <td>Personal 3</td>
        <td>18-05-2016</td>
        <td colspan="2" align="right">Motivo 3&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
