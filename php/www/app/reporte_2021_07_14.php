...
<script type="text/javascript">
	...
	function enviar()
	{
		...
		document.getElementById('msg').value = "...Un momento procesando, esto puede tardar....!!" ;
...
<form id="form1" name="form1" method="post">
  <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
    <tbody>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" name="button" id="button" value="Generar" onClick="enviar();">
<input type="text" name="msg" id="msg" value="" >
      ...
      <tr>
        <td>&nbsp;</td>             
		<td>
              <a href="http://server:8080/birt2/frameset?__report=Costoxcli_remision.rptdesign" id="ver" style="visibility:hidden" target="blank">Ver informe</a>     			
		</td>			
        <td>&nbsp;</td>
      </tr>
